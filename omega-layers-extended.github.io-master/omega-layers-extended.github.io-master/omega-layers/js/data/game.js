var game = {
    ...
    achievements: [
        new Achievement("Alpha Holder MK.I", "Reach 10 α", "α", () => game.layers[0] && game.layers[0].resource.gt(10)),
        new Achievement("Alpha Holder MK.II", "Reach 1e10 α", "α", () => game.layers[0] && game.layers[0].resource.gt(1e10)),
        new Achievement("Alpha Holder MK.III", "Reach 1e100 α", "α", () => game.layers[0] && game.layers[0].resource.gt(1e100)),
        new Achievement("Alpha Holder MK.IV", "Reach 1e1000 α", "α", () => game.layers[0] && game.layers[0].resource.gt(1e1000)),
        new Achievement("Alpha Holder MK.V", "Reach 1e10000 α", "α", () => game.layers[0] && game.layers[0].resource.gt(1e10000)),
        new Achievement("Alpha Holder MK.VI", "Reach 1ee6 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1ee6")),
        new Achievement("Alpha Holder MK.VII", "Reach 1ee9 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1ee9")),
        new Achievement("Alpha Holder MK.VIII", "Reach 1ee18 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1ee18")),
        new Achievement("Alpha Holder MK.XI", "Reach 1ee36 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1ee36")),
