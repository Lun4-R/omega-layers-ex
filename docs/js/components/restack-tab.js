...
<p v-if="showMetaHint && !restack.canMeta()">Check back after reaching <resource-name :layerid="128"></resource-name></p>
<button v-if="restack.canMeta() && !isMeta" @click="restack.goMeta()" class="meta">I have woken up. I am now aware that a new Layer is just another layer. And so it goes on forever. Its time to go for a Meta... To see layers and layers changing on my screen... And never coming back from it... N e v e r...</button>
</div>`
});