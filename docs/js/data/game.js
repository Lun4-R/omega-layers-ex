var game = {
    ...
    automators: {
        ...
        autoPrestige: new Automator("Auto Prestige", "Automatically prestiges all Layers", () =>
        {
            ...
            level => level.gt(0) ? Math.pow(0.5, level.toNumber() - 1) * 30 : Infinity, null, {
                getEffectDisplay: effectDisplayTemplates.automator()
            })),
    ...
    achievements: [
        ...
        new Achievement("Its like half Meta already!", "Buy the Meta Upgrade for 100 times", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.metaUpgrade.level.gt(100)),
        ...
        new Achievement("EXA-Stage", "Reach to EXA-Stage", "<span style='font-size: 82%;'><span><sub>↑</sub></span>", () => game.metaLayer.layer.gte(60)),
        new Achievement("ERA-Stage", "Reach to ERA-Stage", "<span style='font-size: 82%;'><span><sub>↑3↑</sub></span>", () => game.metaLayer.layer.gte(90)),
        new Achievement("EXRA-Stage", "Reach to EXRA-Stage", "<span style='font-size: 82%;'><span><sub>↑9↑</span>", () => game.metaLayer.layer.gte(110)),
        new Achievement("INFINITY-Stage", "Reach to INFINITY-Stage", "<span style='font-size: 82%;'><span><sub>↑81↑</sub></span>", () => game.metaLayer.layer.gte(120)),
        ...
        new Achievement("It truly never Ends", "Reach Layer 1e10", "<span style='font-size: 30%;'><span>Ω<sub>ϝ</sub></span><sup>ρ</sup>↑<span>Ω<sub>ϙ</sub></span><sup>Ν</sup>↑<span>Ω<sub>ϛ</sub></span><sup>κ</sup>↑<span>Ω</span><sup>Σ</sup></span>", () => game.metaLayer.layer.gte(1e50)),
