var game = {
    ...
    achievements: [
        new Achievement("Alpha Holder MK.I", "Reach 100 α", "α", () => game.layers[0] && game.layers[0].resource.gte("100")),
        new Achievement("Alpha Holder MK.II", "Reach 1e60 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e60")),
        new Achievement("Alpha Holder MK.III", "Reach 1e150 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e150")),
        new Achievement("Alpha Holder MK.IV", "Reach 1e300 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e300")),
        new Achievement("Alpha Holder MK.V", "Reach 1e600 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e600")),
        new Achievement("Alpha Holder MK.VI", "Reach 1e1200 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e1200")),
        new Achievement("Alpha Holder MK.VII", "Reach 1e2400 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e2400")),
        new Achievement("Alpha Holder MK.VIII", "Reach 1e4800 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e4800")),
        new Achievement("Alpha Holder MK.XI", "Reach 1e9600 α", "α", () => game.layers[0] && game.layers[0].resource.gte("1e9600")),
